...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    if (walletModel)
    {
        ...
        motogamePage->setModel(walletModel);
...
void WalletView::gotoMotogamePage()
{
    gui->getMotogameAction()->setChecked(true);
    setCurrentWidget(motogamePage);
}
