...
// Copyright (c) 2014-2014 The Motocoin developers
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 MOTO
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 MOTO mininput
...
public:
    ...
    uint256 GetHash() const
    {
        return Hash(BEGIN(nVersion), END(Nonce.Nonce));
    }
...
public:
    ...
    void print() const
    {
        printf("CBlock(hash=%s, input=%s, ver=%d, hashPrevBlock=%s, hashMerkleRoot=%s, nTime=%u, nBits=%08x, vtx=%" PRIszu ")\n",
            GetHash().ToString().c_str(),
...
public:
    ...
    {
        /** Motogame is used for block proof-of-work, but for purposes of performance the index internally uses sha256.
